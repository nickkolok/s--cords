...
Теперь с помощью wxMaxima слеложно найти характеристический определитель:
\begin{multline*}
	\frac{\mathit{k_2}\cdot \left( -\mathrm{P}\left( \mathit{b_1},\mathit{a_1^1}\right) \cdot \mathit{k_3}\cdot \mathit{k_4}-\mathrm{P}\left( \mathit{a_2^4},\mathit{a_1^4}\right) \cdot \left( 1+\mathrm{P}\left( \mathit{b_1},\mathit{a_1^1}\right) \cdot \mathit{k_1}\right) \cdot \mathit{k_3}\cdot \mathit{k_4}-\left( 1+\mathrm{P}\left( \mathit{b_1},\mathit{a_1^1}\right) \cdot \mathit{k_1}\right) \cdot \mathit{k_3}\cdot \left( 1+\mathrm{P}\left( \mathit{b_2},\mathit{a_2^2}\right) \cdot \mathit{k_4}\right) \right) }{\mathrm{p}\left( \mathit{b_3}\right) }-\frac{\left( 1+\mathrm{P}\left( \mathit{b_1},\mathit{a_1^1}\right) \cdot \mathit{k_1}\right) \cdot \mathit{k_3}\cdot \mathit{k_4}}{\mathrm{p}\left( \mathit{b_3}\right) }
\end{multline*}
\end{document}
